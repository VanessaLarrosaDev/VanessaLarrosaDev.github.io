...
const cvConfig = {
    es: {
        filename: 'CV-Vanessa-Larrosa-Vilar.pdf', // Nombre del archivo del CV en español
        path: 'assets/cv/'                           // Ruta donde se encuentra el CV
    },
    en: {
        filename: 'Resume-Vanessa-Larrosa-Vilar.pdf', // Nombre del archivo del CV en inglés
        path: 'assets/cv/'
    }
};
